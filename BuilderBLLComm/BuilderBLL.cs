...
namespace Maticsoft.BuilderBLLComm
{
    ...
    public class BuilderBLL : IBuilder.IBuilderBLL
    {
        ...
        public string GetBLLCode(bool Maxid, bool Exists, bool Add, bool Update, bool Delete, bool GetModel, bool GetModelByCache, bool List)
        {
            ...
            if (GetModelByCache)
            {
                //strclass.AppendLine("using Maticsoft.Common;");_namespace
                strclass.AppendLine("using " + _namespace + ".Common;");
            }
                    ...
                    foreach (ColumnInfo obj in Keys)
                    {
                        if (CodeCommon.DbTypeToCS(obj.TypeName) == "int")
                        {
                            if (obj.IsPrimaryKey)
                            {
                                ...
                                strclass.AppendLine(CreatBLLGetMaxSortNo());
                                break;
                            }
                        }
                    }
            ...
            if (Delete)
            {
                strclass.AppendLine(CreatBLLHide());
        ...
        public string CreatBLLExists()
        {
            ...
            if (_keys.Count > 0)
            {
                ...
                if (!string.IsNullOrEmpty(strInparam))
                {
                    ...
                    strclass.AppendSpaceLine(2, "/// </summary>");
                    strclass.AppendSpaceLine(2, "public bool Exists(" + strInparam + ", bool IsDel = false)");
                    strclass.AppendSpaceLine(2, "{");
                    strclass.AppendSpaceLine(3, "return dal.Exists(" + Maticsoft.CodeHelper.CodeCommon.GetFieldstrlist(Keys, false) + ", IsDel);");
                    strclass.AppendSpaceLine(2, "}");
                }
        ...
        public string CreatBLLDelete()
        {
            ...
            {
                strclass.AppendSpaceLine(2, "/// <summary>");
                strclass.AppendSpaceLine(2, "/// 删除一组数据");
                strclass.AppendSpaceLine(2, "/// </summary>");
                strclass.AppendSpaceLine(2, "public bool DeleteList(string " + keyField + "list )");
                strclass.AppendSpaceLine(2, "{");
                strclass.AppendSpaceLine(3, "return dal.DeleteList(" + _namespace + ".Common.PageValidate.SafeLongFilter(" + keyField + "list,0) );");
                strclass.AppendSpaceLine(2, "}");
            }
            #endregion
        ...
        public string CreatBLLHide()
        {
            ...
            strclass.AppendSpaceLine(2, "/// </summary>");
            strclass.AppendSpaceLine(2, "public bool Hide(" + Maticsoft.CodeHelper.CodeCommon.GetInParameter(Keys, true) + ")");
            strclass.AppendSpaceLine(2, "{");
            strclass.AppendSpaceLine(3, KeysNullTip);
            strclass.AppendSpaceLine(3, "return dal.Hide(" + Maticsoft.CodeHelper.CodeCommon.GetFieldstrlist(Keys, true) + ");");
            strclass.AppendSpaceLine(2, "}");
            ...
            if ((Maticsoft.CodeHelper.CodeCommon.HasNoIdentityKey(Keys)) && (Maticsoft.CodeHelper.CodeCommon.GetIdentityKey(Keys) != null))
            {
                ...
                strclass.AppendSpaceLine(2, "{");
                strclass.AppendSpaceLine(3, KeysNullTip);
                strclass.AppendSpaceLine(3, "return dal.Hide(" + Maticsoft.CodeHelper.CodeCommon.GetFieldstrlist(Keys, false) + ");");
                strclass.AppendSpaceLine(2, "}");
            }
            ...
            if (keyField.Trim().Length > 0)
            {
                ...
                strclass.AppendSpaceLine(2, "{");
                strclass.AppendSpaceLine(3, "return dal.HideList(" + _namespace + ".Common.PageValidate.SafeLongFilter(" + keyField + "list,0) );");
                strclass.AppendSpaceLine(2, "}");
            }
            #endregion
        ...
        public string CreatBLLGetModel()
        {
            ...
            strclass.AppendSpaceLine(2, "/// </summary>");
            strclass.AppendSpaceLine(2, "public " + ModelSpace + " GetModel(" + Maticsoft.CodeHelper.CodeCommon.GetInParameter(Keys, true) + ", bool IsDel = false)");
            strclass.AppendSpaceLine(2, "{");
            strclass.AppendSpaceLine(3, KeysNullTip);
            strclass.AppendSpaceLine(3, "return dal.GetModel(" + Maticsoft.CodeHelper.CodeCommon.GetFieldstrlist(Keys, true) + ", IsDel);");
            strclass.AppendSpaceLine(2, "}");
        ...
        public string CreatBLLGetModelByCache(string ModelName)
        {
            ...
            strclass.AppendSpaceLine(3, "object objModel = " + _namespace + ".Common.DataCache.GetCache(CacheKey);");
            strclass.AppendSpaceLine(3, "if (objModel == null)");
            strclass.AppendSpaceLine(3, "{");
            strclass.AppendSpaceLine(4, "try");
            strclass.AppendSpaceLine(4, "{");
            strclass.AppendSpaceLine(5, "objModel = GetModel(" + Maticsoft.CodeHelper.CodeCommon.GetFieldstrlist(Keys, true) + ");");
            strclass.AppendSpaceLine(5, "if (objModel != null)");
            strclass.AppendSpaceLine(5, "{");
            strclass.AppendSpaceLine(6, "int ModelCache = " + _namespace + ".Common.ConfigHelper.GetConfigInt(\"ModelCache\");");
            //strclass.AppendSpaceLine(6, "int ModelCache = Globals.SafeInt(BLL.SysManage.ConfigSystem.GetValueByCache(\"CacheTime\"), 30);");
            strclass.AppendSpaceLine(6,  _namespace + ".Common.DataCache.SetCache(CacheKey, objModel, DateTime.Now.AddMinutes(ModelCache), TimeSpan.Zero);");
            strclass.AppendSpaceLine(5, "}");
            strclass.AppendSpaceLine(4, "}");
        ...
        public string CreatBLLGetList()
        {
            ...
            strclass.AppendSpaceLine(2, "/// </summary>");
            strclass.AppendSpaceLine(2, "public DataSet GetList(string strWhere, bool IsDel = false, int IsState = 0, string orderby = \"SortNo\", bool IsAsc = true)");
            strclass.AppendSpaceLine(2, "{");
            strclass.AppendSpaceLine(3, "return dal.GetList(strWhere, IsDel, IsState, orderby, IsAsc);");
            strclass.AppendSpaceLine(2, "}");
            ...
            if (param.Length > 1)//至少有其中一个字段
            {
                ...
                strclass.AppendSpaceLine(2, "/// " + Languagelist["summaryGetList"].ToString());
                strclass.AppendSpaceLine(2, "/// </summary>");
                strclass.AppendSpaceLine(2, "public DataSet GetList(string strWhere" + param + ", bool IsDel = false, int IsState = 0, string orderby = \"SortNo\", bool IsAsc = true)");
                strclass.AppendSpaceLine(2, "{");
                ...
                (DbType == "SQL2008") || (DbType == "SQL2012"))
            {
                ...
                strclass.AppendSpaceLine(2, "/// </summary>");
                strclass.AppendSpaceLine(2, "public DataSet GetList(int Top,string strWhere,bool IsDel = false, int IsState = 0, string orderby = \"SortNo\", bool IsAsc = true)");
                strclass.AppendSpaceLine(2, "{");
                strclass.AppendSpaceLine(3, "return dal.GetList(Top, strWhere, IsDel, IsState, orderby, IsAsc);");
                strclass.AppendSpaceLine(2, "}");
            }
            ...
            strclass.AppendSpaceLine(2, "/// " + Languagelist["summaryGetList"].ToString());
            strclass.AppendSpaceLine(2, "/// </summary>");
            strclass.AppendSpaceLine(2, "public List<" + ModelSpace + "> GetModelList(string strWhere, bool IsDel = false, int IsState = 0, string orderby = \"SortNo\", bool IsAsc = true)");
            strclass.AppendSpaceLine(2, "{");
            strclass.AppendSpaceLine(3, "DataSet ds = dal.GetList(strWhere, IsDel, IsState, orderby, IsAsc);");
            ...
            strclass.AppendSpaceLine(4, "{");
            strclass.AppendSpaceLine(5, ModelSpace + " model = new " + ModelSpace + "();");
            #region 字段赋值
            /*
            foreach (ColumnInfo field in Fieldlist)
            {
...
*/
            ...
            strclass.AppendSpaceLine(5, "model = dal.DataRowToModel(model, dt.Rows[n]);");
        ...
        public string CreatBLLGetAllList()
        {
            ...
            strclass.AppendSpaceLine(2, "/// " + Languagelist["summaryGetList"].ToString());
            strclass.AppendSpaceLine(2, "/// </summary>");
            strclass.AppendSpaceLine(2, "public DataSet GetAllList(bool IsDel = false, int IsState = 0, string orderby = \"SortNo\", bool IsAsc = true)");
            strclass.AppendSpaceLine(2, "{");
            strclass.AppendSpaceLine(3, "return GetList(\"\",IsDel,IsState,orderby,IsAsc);");
            strclass.AppendSpaceLine(2, "}");
            return strclass.ToString();
        }
        public string CreatBLLGetListByPage()
        {
            ...
            strclass.AppendSpaceLine(2, "/// </summary>");
            strclass.AppendSpaceLine(2, "public int GetRecordCount(string strWhere, bool IsDel = false, int IsState = 0)");
            strclass.AppendSpaceLine(2, "{");
            strclass.AppendSpaceLine(3, "return dal.GetRecordCount(strWhere,IsDel,IsState);");
            strclass.AppendSpaceLine(2, "}");

            strclass.AppendSpaceLine(2, "/// <summary>");
            strclass.AppendSpaceLine(2, "/// " + Languagelist["summaryGetList3"].ToString());
            strclass.AppendSpaceLine(2, "/// </summary>");
            strclass.AppendSpaceLine(2, "public DataSet GetListByPage(string strWhere, int startIndex, int endIndex, bool IsDel = false, int IsState = 0, string orderby = \"SortNo\",  bool IsAsc = true)");
            strclass.AppendSpaceLine(2, "{");
            strclass.AppendSpaceLine(3, "return dal.GetListByPage(strWhere, orderby, startIndex, endIndex, IsDel, IsState, IsAsc);");
            strclass.AppendSpaceLine(2, "}");
            ...
            strclass.AppendSpaceLine(2, "/// " + Languagelist["summaryGetList3"].ToString());
            strclass.AppendSpaceLine(2, "/// </summary>");
            strclass.AppendSpaceLine(2, "public DataSet GetListByPageProc(int PageSize,int PageIndex,string strWhere, bool IsDel = false, int IsState = 0, bool IsAsc = true)");
            strclass.AppendSpaceLine(2, "{");
            strclass.AppendSpaceLine(3, "return dal.GetListByPageProc(PageSize,PageIndex,strWhere,IsDel,IsState,IsAsc);");
            strclass.AppendSpaceLine(2, "}");

            strclass.AppendSpaceLine(2, "/// <summary>");
            strclass.AppendSpaceLine(2, "/// 存储过程分页获取数据列表");
            strclass.AppendSpaceLine(2, "/// </summary>");
            strclass.AppendSpaceLine(2, "public DataSet GetListByPageOrderProc(int PageSize,int PageIndex,string strWhere, out int Total, string orderby = \"SortNo\", bool IsAsc = true, bool IsDel = false, int IsState = 0)");
            strclass.AppendSpaceLine(2, "{");
            strclass.AppendSpaceLine(3, "return dal.GetListByPageOrderProc(PageSize,PageIndex,strWhere,out Total,orderby,IsAsc,IsDel,IsState);");
            strclass.AppendSpaceLine(2, "}");
            return strclass.ToString();
        }
