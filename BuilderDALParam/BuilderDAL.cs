...
namespace Maticsoft.BuilderDALParam
{
    ...
    public class BuilderDAL : Maticsoft.IBuilder.IBuilderDAL
    {
        ...
        public string Modelpath
        {
            ...
            get { return _modelpath.Replace("Model", "Entity"); }
        }
        /// <summary>
        /// 实体类名
        /// </summary>
        ...
        public string GetDALCode(bool Maxid, bool Exists, bool Add, bool Update, bool Delete, bool GetModel, bool List)
        {
            ...
            strclass.AppendLine("using " + _namespace + ".DBUtility;");
            ...
            if (Maxid)
            {
                ...
                strclass.AppendLine(CreatGetMaxSortNo());
            }
            if (Exists)
            {
            ...
            if (GetModel)
            {
                ...
                strclass.AppendLine(CreatDataRowToModelNew());
            }
            if (List)
            {
                ...
                strclass.AppendLine(CreatGetListByPageOrderProc());
            }
            #endregion
                ...
                foreach (ColumnInfo obj in _keys)
                {
                    if (CodeCommon.DbTypeToCS(obj.TypeName) == "int")
                    {
                        ...
                        if (obj.IsPrimaryKey)
                        {
                            ...
                            strclass.AppendSpaceLine(2, "{");
                            strclass.AppendSpaceLine(3, "return " + DbHelperName + ".GetMaxID(\"" + keyname + "\", \"" + _tablename + "\"); ");
                            strclass.AppendSpaceLine(2, "}");
                            break;
                        }
                    }
        ...
        /// <param name="ID"></param>
        /// <returns></returns>
        public string CreatGetMaxSortNo()
        {
            StringPlus strclass = new StringPlus();
            if (_keys.Count > 0)
            {
                ...
                foreach (ColumnInfo obj in _keys)
                {
                    if (CodeCommon.DbTypeToCS(obj.TypeName) == "int")
                    {
                        ...
                        if (obj.IsPrimaryKey)
                        {
                            ...
                            strclass.AppendSpaceLine(2, "{");
                            strclass.AppendSpaceLine(3, "return " + DbHelperName + ".GetMaxID(\"SortNo\", \"" + _tablename + "\"); ");
                            strclass.AppendSpaceLine(2, "}");
                            break;
                        }
                    }
        ...
        public string CreatExists()
        {
            ...
            if (_keys.Count > 0)
            {
                ...
                if (!string.IsNullOrEmpty(strInparam))
                {
                    ...
                    strclass.AppendSpaceLine(2, "/// </summary>");
                    strclass.AppendSpaceLine(2, "public bool Exists(" + strInparam + ", bool IsDel)");
                    strclass.AppendSpaceLine(2, "{");
                    ...
                    strclass.AppendSpaceLine(3, "if(IsDel)");
                    strclass.AppendSpaceLine(3, "{");
                    strclass.AppendSpaceLine(4, "strSql.Append(\" and IsDel= 1\");");
                    strclass.AppendSpaceLine(3, "}");
                    strclass.AppendSpaceLine(3, "else");
                    strclass.AppendSpaceLine(3, "{");
                    strclass.AppendSpaceLine(4, "strSql.Append(\" and IsDel= 0\");");
                    strclass.AppendSpaceLine(3, "}");
        ...
        /// <param name="_key"></param>
        /// <returns></returns>
        public string CreatHide()
        {
            StringPlus strclass = new StringPlus();

            #region 标识字段优先-删除
            strclass.AppendSpaceLine(2, "/// <summary>");
            strclass.AppendSpaceLine(2, "/// 逻辑删除一条数据");
            strclass.AppendSpaceLine(2, "/// </summary>");
            strclass.AppendSpaceLine(2, "public bool Hide(" + CodeCommon.GetInParameter(Keys, true) + ")");
            strclass.AppendSpaceLine(2, "{");
            strclass.AppendSpaceLine(3, KeysNullTip);
            strclass.AppendSpaceLine(3, "StringBuilder strSql=new StringBuilder();");
            strclass.AppendSpaceLine(3, "strSql.Append(\"update " + _tablename + " set IsDel = 1 \");");
            strclass.AppendSpaceLine(3, "strSql.Append(\" where " + CodeCommon.GetWhereParameterExpression(Keys, true, dbobj.DbType) + "\");");
            strclass.AppendLine(CodeCommon.GetPreParameter(Keys, true, dbobj.DbType));
            strclass.AppendSpaceLine(3, "int rows=" + DbHelperName + ".ExecuteSql(strSql.ToString(),parameters);");
            strclass.AppendSpaceLine(3, "if (rows > 0)");
            ...
            if ((Maticsoft.CodeHelper.CodeCommon.HasNoIdentityKey(Keys)) && (Maticsoft.CodeHelper.CodeCommon.GetIdentityKey(Keys) != null))
            {
                ...
                strclass.AppendSpaceLine(2, "/// 逻辑删除一条数据");
                strclass.AppendSpaceLine(2, "/// </summary>");
                strclass.AppendSpaceLine(2, "public bool Hide(" + Maticsoft.CodeHelper.CodeCommon.GetInParameter(Keys, false) + ")");
                strclass.AppendSpaceLine(2, "{");
                strclass.AppendSpaceLine(3, KeysNullTip);
                strclass.AppendSpaceLine(3, "StringBuilder strSql=new StringBuilder();");
                strclass.AppendSpaceLine(3, "strSql.Append(\"update " + _tablename + " set IsDel = 1 \");");
            ...
            {
                strclass.AppendSpaceLine(2, "/// <summary>");
                strclass.AppendSpaceLine(2, "/// 逻辑删除一组数据");
                strclass.AppendSpaceLine(2, "/// </summary>");
                strclass.AppendSpaceLine(2, "public bool HideList(string " + keyField + "list )");
                strclass.AppendSpaceLine(2, "{");
                strclass.AppendSpaceLine(3, "StringBuilder strSql=new StringBuilder();");
                strclass.AppendSpaceLine(3, "strSql.Append(\"update " + _tablename + " set IsDel = 1 \");");
                strclass.AppendSpaceLine(3, "strSql.Append(\" where " + keyField + " in (\"+" + keyField + "list + \")  \");");
        ...
        public string CreatGetModel()
        {
            ...
            strclass.AppendSpaceLine(2, "/// </summary>");
            strclass.AppendSpaceLine(2, "public " + ModelSpace + " GetModel(" + Maticsoft.CodeHelper.CodeCommon.GetInParameter(Keys, true) + ", bool IsDel)");
            strclass.AppendSpaceLine(2, "{");
            strclass.AppendSpaceLine(3, KeysNullTip);
            strclass.AppendSpaceLine(3, "StringBuilder strSql=new StringBuilder();");
            ...
            strclass.AppendSpaceLine(4, "return DataRowToModel(model, ds.Tables[0].Rows[0]);");
            strclass.AppendSpaceLine(3, "}");
            strclass.AppendSpaceLine(3, "else");
            strclass.AppendSpaceLine(3, "{");
        ...
        /// DataRowToModel的代码
        /// </summary>      
        public string CreatDataRowToModelNew()
        {
            if (ModelSpace == "")
            {
                //ModelSpace = "ModelClassName"; ;
            ...
            strclass.AppendLine();
            strclass.AppendSpaceLine(2, "/// <summary>");
            strclass.AppendSpaceLine(2, "/// 将DataRow赋值给model中同名属性");
            strclass.AppendSpaceLine(2, "/// </summary>");
            strclass.AppendSpaceLine(2, "/// <typeparam name=\"T\">泛型：model的类型</typeparam>");
            strclass.AppendSpaceLine(2, "/// <param name=\"model\">model实例</param>");
            strclass.AppendSpaceLine(2, "/// <param name=\"dtRow\">DataTable行数据</param>");
            strclass.AppendSpaceLine(2, "public T DataRowToModel<T>(T model, DataRow dtRow)");
            strclass.AppendSpaceLine(2, "{");
            strclass.AppendSpaceLine(3, "Type modelType = typeof(T);//获取model的类型");
            strclass.AppendSpaceLine(3, "System.Reflection.PropertyInfo[] modelpropertys = modelType.GetProperties();//获取model中的属性");
            strclass.AppendSpaceLine(3, "//遍历model每一个属性并赋值DataRow对应的列");
            strclass.AppendSpaceLine(3, "foreach (System.Reflection.PropertyInfo pi in modelpropertys)");
            strclass.AppendSpaceLine(3, "{");

            #region 字段赋值           
            strclass.AppendSpaceLine(4, "String name = pi.Name;//获取属性名称");
            strclass.AppendSpaceLine(4, "if (dtRow.Table.Columns.Contains(name))");
            strclass.AppendSpaceLine(4, "{");
            strclass.AppendSpaceLine(5, "if (!pi.PropertyType.IsGenericType)//非泛型");
            strclass.AppendSpaceLine(5, "{");
            strclass.AppendSpaceLine(6, "pi.SetValue(model, string.IsNullOrEmpty(dtRow[name].ToString()) ? null : Convert.ChangeType(dtRow[name], pi.PropertyType), null);");
            strclass.AppendSpaceLine(5, "}");
            strclass.AppendSpaceLine(5, "else//泛型Nullable<>");
            strclass.AppendSpaceLine(5, "{");
            strclass.AppendSpaceLine(6, "Type genericTypeDefinition = pi.PropertyType.GetGenericTypeDefinition();");
            strclass.AppendSpaceLine(6, "//model属性是可为null类型，进行赋null值");
            strclass.AppendSpaceLine(6, "if (genericTypeDefinition == typeof(Nullable<>))");
            strclass.AppendSpaceLine(6, "{");
            strclass.AppendSpaceLine(7, "//返回指定可以为 null 的类型的基础类型参数");
            strclass.AppendSpaceLine(7, "pi.SetValue(model, string.IsNullOrEmpty(dtRow[name].ToString()) ? null : Convert.ChangeType(dtRow[name], Nullable.GetUnderlyingType(pi.PropertyType)), null);");
            strclass.AppendSpaceLine(6, "}");
            strclass.AppendSpaceLine(5, "}");
            strclass.AppendSpaceLine(4, "}");
        ...
        public string CreatGetList()
        {
            ...
            strclass.AppendSpaceLine(2, "/// </summary>");
            strclass.AppendSpaceLine(2, "public DataSet GetList(string strWhere, bool IsDel, int IsState, string orderby, bool IsAsc)");
            strclass.AppendSpaceLine(2, "{");
            strclass.AppendSpaceLine(3, "StringBuilder strSql=new StringBuilder();");
            strclass.AppendSpace(3, "strSql.Append(\"select ");
            ...
            //判断where条件及是否逻辑删除
            strclass.AppendSpaceLine(3, "strSql.Append(\" where IsState= \" + IsState);");
            strclass.AppendSpaceLine(3, "if (IsDel)");
            strclass.AppendSpaceLine(3, "{");
            strclass.AppendSpaceLine(4, "strSql.Append(\" and IsDel = 1 \");");
            strclass.AppendSpaceLine(3, "}");
            ...
            //判断排序
            strclass.AppendSpaceLine(3, "if(IsAsc)");
            strclass.AppendSpaceLine(3, "{");
            strclass.AppendSpaceLine(4, "strSql.Append(\" order by \" + orderby);");
            strclass.AppendSpaceLine(3, "}");
            strclass.AppendSpaceLine(3, "else");
            strclass.AppendSpaceLine(3, "{");
            strclass.AppendSpaceLine(4, "strSql.Append(\" order by \" + orderby + \" desc\");");
            strclass.AppendSpaceLine(3, "}");
               ...
               (dbobj.DbType == "SQL2012"))
            {
                ...
                strclass.AppendSpaceLine(2, "/// </summary>");
                strclass.AppendSpaceLine(2, "public DataSet GetList(int Top,string strWhere,bool IsDel, int IsState, string orderby, bool IsAsc)");
                strclass.AppendSpaceLine(2, "{");
                strclass.AppendSpaceLine(3, "StringBuilder strSql=new StringBuilder();");
                ...
                //判断where条件及是否逻辑删除
                strclass.AppendSpaceLine(3, "strSql.Append(\" where IsState= \" + IsState);");
                strclass.AppendSpaceLine(4, "if (IsDel)");
                strclass.AppendSpaceLine(4, "{");
                strclass.AppendSpaceLine(5, "strSql.Append(\" and IsDel = 1 \");");
                strclass.AppendSpaceLine(4, "}");
                strclass.AppendSpaceLine(4, "else");
                strclass.AppendSpaceLine(4, "{");
                strclass.AppendSpaceLine(5, "strSql.Append(\" and IsDel = 0 \");");
                strclass.AppendSpaceLine(4, "}");
                strclass.AppendSpaceLine(3, "if(strWhere.Trim()!=\"\")");
                strclass.AppendSpaceLine(3, "{");
                strclass.AppendSpaceLine(4, "strSql.Append(\" and \"+strWhere);");
        ...
        public string CreatGetListByPage()
        {
            ...
            strclass.AppendSpaceLine(2, "/// </summary>");
            strclass.AppendSpaceLine(2, "public int GetRecordCount(string strWhere,bool IsDel, int IsState)");
            strclass.AppendSpaceLine(2, "{");
            strclass.AppendSpaceLine(3, "StringBuilder strSql=new StringBuilder();");            
            ...
            strclass.AppendSpaceLine(2, "/// </summary>");
            strclass.AppendSpaceLine(2, "public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex, bool IsDel, int IsState, bool IsAsc)");
            strclass.AppendSpaceLine(2, "{");
            strclass.AppendSpaceLine(3, "StringBuilder strSql=new StringBuilder();");
            ...
            strclass.AppendSpaceLine(3, "else");
            strclass.AppendSpaceLine(3, "{");
            strclass.AppendSpaceLine(4, "strSql.Append(\"order by T.\" + orderby + \" desc\");");
            strclass.AppendSpaceLine(3, "}");
            ...
            //strclass.AppendSpaceLine(4, "if (IsDel)");
            //strclass.AppendSpaceLine(4, "{");
            //strclass.AppendSpaceLine(5, "strSql.Append(\" where IsDel = 1 and \"+strWhere);");
            //strclass.AppendSpaceLine(4, "}");
            //strclass.AppendSpaceLine(4, "else");
            //strclass.AppendSpaceLine(4, "{");
            //strclass.AppendSpaceLine(5, "strSql.Append(\" where IsDel = 0 and \"+strWhere);");
            //strclass.AppendSpaceLine(4, "}");
            ...
            //strclass.AppendSpaceLine(4, "if (IsDel)");
            //strclass.AppendSpaceLine(4, "{");
            //strclass.AppendSpaceLine(5, "strSql.Append(\" where IsDel = 1\");");
            //strclass.AppendSpaceLine(4, "}");
            //strclass.AppendSpaceLine(4, "else");
            //strclass.AppendSpaceLine(4, "{");
            //strclass.AppendSpaceLine(5, "strSql.Append(\" where IsDel = 0\");");
            //strclass.AppendSpaceLine(4, "}");
            //strclass.AppendSpaceLine(3, "}");
        ...
        public string CreatGetListByPageProc()
        {
            ...
            strclass.AppendSpaceLine(2, "/// " + Languagelist["summaryGetList3"].ToString());
            strclass.AppendSpaceLine(2, "/// </summary>");
            strclass.AppendSpaceLine(2, "public DataSet GetListByPageProc(int PageSize,int PageIndex,string strWhere,bool IsDel,int IsState, bool IsAsc)");
            strclass.AppendSpaceLine(2, "{");
            strclass.AppendSpaceLine(3, "" + DbParaHead + "Parameter[] parameters = {");
            ...
            strclass.AppendSpaceLine(3, "parameters[1].Value = \"*\";");
            ...
            strclass.AppendSpaceLine(3, "if(IsAsc)");
            strclass.AppendSpaceLine(3, "{");
            strclass.AppendSpaceLine(4, "parameters[5].Value = 1;");
            strclass.AppendSpaceLine(3, "}");
            strclass.AppendSpaceLine(3, "else");
            strclass.AppendSpaceLine(3, "{");
            strclass.AppendSpaceLine(4, "parameters[5].Value = 0;");
            strclass.AppendSpaceLine(3, "}");

            strclass.AppendSpaceLine(3, "if(IsDel)");
            strclass.AppendSpaceLine(3, "{");
            strclass.AppendSpaceLine(4, "parameters[6].Value = \"IsDel=1 and IsState = \" + IsState + \" and \" + strWhere;");
            strclass.AppendSpaceLine(3, "}");
            strclass.AppendSpaceLine(3, "else");
            strclass.AppendSpaceLine(3, "{");
            strclass.AppendSpaceLine(4, "parameters[6].Value = \"IsDel=0 and IsState = \" + IsState + \" and \" + strWhere;");
            strclass.AppendSpaceLine(3, "}");
        ...
        /// <param name="_key"></param>
        /// <returns></returns>
        public string CreatGetListByPageOrderProc()
        {
            StringPlus strclass = new StringPlus();
            strclass.AppendSpaceLine(2, "/// <summary>");
            strclass.AppendSpaceLine(2, "/// 得到存储过程分页的代码");
            strclass.AppendSpaceLine(2, "/// </summary>");
            strclass.AppendSpaceLine(2, "public DataSet GetListByPageOrderProc(int PageSize,int PageIndex, string strWhere, out int Total, string orderby, bool IsAsc, bool IsDel, int IsState)");
            strclass.AppendSpaceLine(2, "{");
            strclass.AppendSpaceLine(3, "" + DbParaHead + "Parameter[] parameters = {");
            strclass.AppendSpaceLine(5, "new " + DbParaHead + "Parameter(\"" + preParameter + "tblName\", " + DbParaDbType + ".VarChar, 255),");
            strclass.AppendSpaceLine(5, "new " + DbParaHead + "Parameter(\"" + preParameter + "fldName\", " + DbParaDbType + ".VarChar, 255),");
            strclass.AppendSpaceLine(5, "new " + DbParaHead + "Parameter(\"" + preParameter + "OrderfldName\", " + DbParaDbType + ".VarChar, 255),");
            strclass.AppendSpaceLine(5, "new " + DbParaHead + "Parameter(\"" + preParameter + "PageSize\", " + DbParaDbType + "." + CodeCommon.CSToProcType(dbobj.DbType, "int") + "),");
            strclass.AppendSpaceLine(5, "new " + DbParaHead + "Parameter(\"" + preParameter + "PageIndex\", " + DbParaDbType + "." + CodeCommon.CSToProcType(dbobj.DbType, "int") + "),");
            strclass.AppendSpaceLine(5, "new " + DbParaHead + "Parameter(\"" + preParameter + "IsReCount\", " + DbParaDbType + "." + CodeCommon.CSToProcType(dbobj.DbType, "bit") + "),");
            strclass.AppendSpaceLine(5, "new " + DbParaHead + "Parameter(\"" + preParameter + "OrderType\", " + DbParaDbType + "." + CodeCommon.CSToProcType(dbobj.DbType, "bit") + "),");
            ...
            strclass.AppendSpaceLine(3, "parameters[0].Value = \"" + this.TableName + "\";");
            strclass.AppendSpaceLine(3, "parameters[1].Value = \"*\";");
            strclass.AppendSpaceLine(3, "parameters[2].Value = orderby;");
            strclass.AppendSpaceLine(3, "parameters[3].Value = PageSize;");
            strclass.AppendSpaceLine(3, "parameters[4].Value = PageIndex;");
            strclass.AppendSpaceLine(3, "parameters[5].Value = 1;");

            strclass.AppendSpaceLine(3, "if(IsAsc)");
            strclass.AppendSpaceLine(3, "{");
            strclass.AppendSpaceLine(4, "parameters[6].Value = 1;");
            strclass.AppendSpaceLine(3, "}");
            strclass.AppendSpaceLine(3, "else");
            strclass.AppendSpaceLine(3, "{");
            strclass.AppendSpaceLine(4, "parameters[6].Value = 0;");
            strclass.AppendSpaceLine(3, "}");

            strclass.AppendSpaceLine(3, "if(IsDel)");
            strclass.AppendSpaceLine(3, "{");
            strclass.AppendSpaceLine(4, "parameters[7].Value = \"IsDel=1 and IsState = \" + IsState + \" and \" + strWhere;");
            strclass.AppendSpaceLine(3, "}");
            strclass.AppendSpaceLine(3, "else");
            strclass.AppendSpaceLine(3, "{");
            strclass.AppendSpaceLine(4, "parameters[7].Value = \"IsDel=0 and IsState = \" + IsState + \" and \" + strWhere;");
            strclass.AppendSpaceLine(3, "}");

            strclass.AppendSpaceLine(3, "return " + DbHelperName + ".RunProcedure(\"UP_GetRecordByPage\",parameters,\"ds\",out Total);");
            strclass.AppendSpaceLine(2, "}");
            return strclass.Value;
        }
