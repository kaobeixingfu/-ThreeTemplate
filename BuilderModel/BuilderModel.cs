...
namespace Maticsoft.BuilderModel
{
    ...
    public class BuilderModel : IBuilder.IBuilderModel
    {
        ...
        public string CreatModel()
        {
            ...
            //_modelname = ChangeColumnName(_modelname);
            ...
            {
                strclass.AppendSpaceLine(1, "/// " + _modelname + ":" + TableDescription);
            }
            strclass.AppendSpaceLine(1, "/// </summary>");
        ...
        public string CreatModelMethod()
        {
            ...
            strclass.AppendSpaceLine(2, "#region Entity");
            foreach (ColumnInfo field in Fieldlist)
            {
                string columnName = field.ColumnName;
                //columnName = ChangeColumnName(columnName);
            ...
            strclass.AppendSpaceLine(2, "#endregion Entity");
        ...
        {
            string[] strArray = ColumnName.Split("_".ToCharArray());
            string result = string.Empty;//定义一个空字符串
 
            foreach (string s in strArray)//循环处理数组里面每一个字符串
            {
                result += s[0].ToString().ToUpper() + s.Substring(1).ToLower();
            }
            return result;
        }
    }
